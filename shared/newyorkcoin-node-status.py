...
ff.write("""<title>Litecoin supernode status - By newyorkcoinnode.org</title>""")
ff.write("""<meta name="viewport" content="width=device-width, initial-scale=1.0">""")
ff.write("""<meta name="description" content="Litecoin supernode status - By newyorkcoinnode.org">""")
...
ff.write("""<h3>Litecoin supernode status - By newyorkcoinnode.org</h3><hr>""")
ff.write("""</div>""")
ff.write("""</div>""")
ff.write("""<div>""")
ff.write("""<div>""")
...
ff.write("""<p><a href="http://newyorkcoinnode.org/">NewYorkCoinNode</a> is a small project that aims to make it easy for individuals to deploy and maintain Litecoin supernodes.</p>""")
ff.write("""<p>If you like the project please consider making a donation to the Litecoin or Bitcoin address below.</p>""")
ff.write("""<table class="table table-striped">""")
ff.write("""<tr><td>Litecoin</td><td><a href="newyorkcoin:LYSBpbh7NFmTykMg5PcrMgEuN7tVNmVA4Q?amount=0.0&label=newyorkcoinnode.org">LYSBpbh7NFmTykMg5PcrMgEuN7tVNmVA4Q</a></td></tr>""")
...
ff.write("""<li class="pull-right"><a href="https://newyorkcoin.com/">Litecoin</a></li></ul>""")
ff.write("""</div>""")
ff.write("""</div>""")
ff.write("""</body>""")
ff.write("""</html>""")
