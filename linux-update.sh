...
echo "-----------------------------------------------------------------------"
echo ""
echo "Welcome to the NewYorkCoin node update script."
echo "This script will update the NewYorkCoin full node on your computer."
...
echo "For more information or help visit https://nycoin.community/newyorkcoinnode"
echo ""
echo "-----------------------------------------------------------------------"
echo ""
